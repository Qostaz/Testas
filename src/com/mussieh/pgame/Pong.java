...
public class Pong
{
   ...
   private static final int PADDLE_VERTICAL_LOW_VELOCITY_CONSTANT = 50;
   private static final int PADDLE_VERTICAL_HIGH_VELOCITY_CONSTANT = 70;
   ...
   private static final int EASY_MODE_LIVES_LEFT_CONSTANT = 10;
   ...
   public void displayScene()
   {
      ...
      JOptionPane.showMessageDialog(frame,
            "Use the arrow keys for moving the paddle. UP for going up"
            + " while DOWN for going down.");
